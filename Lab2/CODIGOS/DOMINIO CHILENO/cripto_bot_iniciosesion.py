...
if __name__ == "__main__":
    ...
    mail.clear()
    mail = driver.find_element(By.ID, "user_email")
    mail.send_keys("raulautotrans@gmail.com")
    driver.find_element(By.ID, "user_password").click()
    passw.clear()
    passw = driver.find_element(By.ID, "user_password")
    passw.send_keys("mvc141455")
    time.sleep(1)
    driver.find_element(By.XPATH, "//*[@id='submit-login']").click()
    time.sleep(1)
    ...
    mail.clear()
    mail = driver.find_element(By.ID, "user_email")
    mail.send_keys("metropolisinternet.com")
    driver.find_element(By.ID, "user_password").click()
    passw.clear()
    passw = driver.find_element(By.ID, "user_password")
    passw.send_keys("pq3e5r4ty3d670")
    time.sleep(1)
    driver.find_element(By.XPATH, "//*[@id='submit-login']").click()
    time.sleep(1)
    ...
    mail.clear()
    mail = driver.find_element(By.ID, "user_email")
    mail.send_keys("sherrera@v gi.cl")
    driver.find_element(By.ID, "user_password").click()
    passw.clear()
    passw = driver.find_element(By.ID, "user_password")
    passw.send_keys("5cmJAkpcyv")
    time.sleep(1)
    driver.find_element(By.XPATH, "//*[@id='submit-login']").click()
    time.sleep(1)
